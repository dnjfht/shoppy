    ...
    <div className="w-full">
      <div className="w-[1400px] mx-auto pt-52 pb-20 flex justify-between">
        ...
        <div className="w-[47%]">
          ...
          <div className="w-full pt-[30px] pb-[16px] text-[0.875rem] text-[#333] font-semibold flex justify-between items-center">
            <p>총 상품 금액</p>
          ...
          <div className="flex justify-between items-center font-semibold">
            <button className="w-[12rem] py-5 border-[1px] border-solid border-black">
              장바구니
            </button>
            <button className="w-[12rem] py-5 bg-[#333] text-white">
              구매하기
            </button>
            <button className="w-[12rem] py-5 bg-black flex justify-center items-center text-white">
