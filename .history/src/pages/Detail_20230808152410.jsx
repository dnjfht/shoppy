...
export default function Detail({
  ...
  console.log(
    ...
    reviewBodySize,
    reviewBodyFoot,
    reviewColorSatisfaction,
    reviewSizeSatisfaction,
    reviewSatisfaction,
    content,
    reviewData
  );
          ...
          <div className="w-full flex justify-between">
            ...
            <div className="w-[72%] p-5 box-border">
              ...
              <div className="w-full mt-3 text-center flex flex-col items-center">
                ...
                <div className="w-full flex justify-between items-center">
                  <input
                    ...
                    } w-[31%] py-2 border-[1px] border-solid rounded-full cursor-pointer`}
                    type="button"
                    value="연해요"
                  ...
                  <input
                    className={`${
                      reviewColorSatisfaction === "진해요"
                        ? "border-[#ff4273] text-[#ff4273]"
                        : "border-[#c1c1c1] text-[#a1a1a1]"
                    } w-[31%] py-2 border-[1px] border-solid rounded-full cursor-pointer transition`}
                    type="button"
                    value="진해요"
                    onClick={(e) => setReviewColorSatisfaction(e.target.value)}
                  />
              ...
              <div className="w-full mt-6 text-center flex flex-col items-center">
                ...
                <div className="w-full flex justify-between items-center">
                  <input
                    className="w-[31%] py-2 border-[1px] border-solid border-[#c1c1c1] rounded-full text-[#a1a1a1] cursor-pointer"
                    type="button"
                    value="작아요"
