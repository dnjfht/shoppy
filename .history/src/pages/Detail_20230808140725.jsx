            ...
            <div className="w-[72%] p-5 box-border">
              ...
              <div className="w-full mt-3 text-center flex flex-col items-center">
                ...
                <div className="w-full flex justify-between items-center">
                  <input
                    className="w-[31%] py-2 border-[1px] border-solid border-[#c1c1c1] rounded-full text-[#acacac]"
                    type="button"
                    value="연해요"
                    onClick={(e) => setReviewColorSatisfaction(e.target.value)}
                  />
                  <input
                    className="w-[31%] py-2 border-[1px] border-solid border-[#c1c1c1] rounded-full text-[#c1c1c1]"
                    type="button"
                    value="똑같아요"
                    onClick={(e) => setReviewColorSatisfaction(e.target.value)}
                  />
