                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items border-[1px] border-solid border-[#282828]">
                        <button className="py-1 px-2 flex justify-center items-center border-r-[1px] border-solid border-[#282828]">
                          -
                        </button>
                        <p className="py-1 px-2">{c.count}</p>
                        <button className="py-1 px-2 flex justify-center items-cente border-l-[1px] border-solid border-[#282828]">
                          +
                        </button>
                      </div>
