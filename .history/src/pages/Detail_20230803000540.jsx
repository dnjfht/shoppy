        ...
        <div className="w-[47%]">
          ...
          <div className="w-full py-[30px]">
            <div className="w-full mb-2 flex">
              <p className="w-1/6 text-[0.875rem] text-[#999] font-semibold">
                판매가
              </p>
              <p className="line-through w-5/6">{attach_won(item.price)}</p>
            </div>
            <div className="w-full mb-2 flex">
              <p className="w-1/6 text-[0.875rem] text-[#999]">할인판매가</p>
              <p className="w-5/6">{attach_won(item.salePrice)}</p>
            </div>
            <div className="w-full flex">
              <p className="w-1/6 text-[0.875rem] text-[#999]">상품간략설명</p>
