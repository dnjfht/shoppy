            ...
            <div className="w-[72%] p-5 box-border">
              <div>
                <div className="w-full flex flex-wrap">
                  {!user && (
                    <>
                      <div className="w-1/2 p-3 border-y-[1px] border-l-[1px] border-solid border-[#282828] rounded-l-lg flex items-center">
                        <label className="w-[30%]" htmlFor="phoneNumber">
                          전화번호
                        </label>
                        <input
                          id="phoneNumber"
                          className="w-[60%] ml-3 bg-fuchsia-300 outline-none"
                          type="text"
                      ...
                      <div className="w-1/2 p-3 border-[1px] border-solid border-[#282828] rounded-r-lg flex items-center">
                        <label lassName="w-[30%]" htmlFor="password">
                          비밀번호
                        </label>
                        <input
                          id="password"
                  ...
                  {item?.option?.size && (
                    <select
                      ...
                      className="text-center text-[#ff4273] w-1/2 p-3 mt-2 border-[1px] bg-transparent border-solid border-[#ff4273] outline-none rounded-l-lg placeholder:text-[]"
                    >
                      <option disabled selected>
                        옵션 색상 선택
                      </option>
