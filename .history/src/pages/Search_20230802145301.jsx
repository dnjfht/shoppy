        ...
        <div className="w-1/2 mt-20">
          ...
          <div className="flex items-center">
            ...
            <input
              ...
              className="w-[38%] px-4 py-6 mr-[1%] placeholder:text-[#a5a5a5] bg-[rgba(0,0,0,0.6)] border-[2px] border-solid border-white"
            />
            ...
            <input
              ...
              className="w-[38%] px-4 py-6 ml-[1%] placeholder:text-[#a5a5a5] bg-[rgba(0,0,0,0.6)] border-[2px] border-solid border-white"
            />
          </div>
