...
export default function Detail({
  ...
  const [reviewWeight, setReviewWeight] = useState(0);
  const [reviewBodySize, setReviewBodySize] = useState(0o0);
  const [reviewBodyFoot, setReviewBodyFoot] = useState(0);
                ...
                <div className="w-full flex">
                  {item?.option?.size && (
                    <select
                      ...
                      className="w-5/6 p-3 border-[1px] bg-transparent border-solid border-[#282828] outline-none rounded-l-lg"
                    >
                      <option disabled selected>
                        옵션 색상 선택
                      </option>
                  ...
                  {item?.option?.size && (
                    <select
                      ...
                      className="w-5/6 p-3 border-[1px] bg-transparent border-solid border-[#282828] outline-none rounded-r-lg"
                    >
                      <option disabled selected>
                        옵션 사이즈 선택
                      </option>
