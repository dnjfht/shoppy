                      ...
                      <div className="w-full pb-4 pl-5 box-border flex items-center border-b-[1px] shadow-lg">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-[0.75rem] text-[#888]">
                            {user ? review.userId : review.phoneNumber}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="w-full py-5 text-[0.8125rem]">
                        ...
                        <div className="mt-14 flex items-center">
                          {user && user.uid === review.userId && (
                            <>
                              <button className="w-[100px] h-[30px] border-[1px] border-solid border-[#ff4273] text-[0.8125rem] rounded-lg text-[#ff4273] flex justify-center items-center">
                                수정하기
                              </button>
                              <button className="w-[100px] h-[30px] ml-2 border-[1px] border-solid border-[#ff4273] text-[0.8125rem] rounded-lg text-[#ff4273] flex justify-center items-center">
                                삭제하기
                              </button>
                            </>
                          )}
