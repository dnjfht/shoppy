...
export default function Detail() {
  ...
  const category = ["상품정보", "사용후기", "교환 및 상품", "상품문의"];
      ...
      <div className="w-[1400px] mx-auto pt-52 pb-20 flex flex-col justify-between">
        ...
        <div className="w-full">
          ...
          <div className="bg-red-500">
            ...
            {cat === "사용후기" && <DetailInfo detailImg={item.detailImg} />}
            {cat === "교환 및 상품" && (
              <DetailInfo detailImg={item.detailImg} />
            )}
            {cat === "상품문의" && <DetailInfo detailImg={item.detailImg} />}
          </div>
        </div>
      </div>
    </div>
