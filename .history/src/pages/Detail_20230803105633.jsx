          ...
          <div className="w-full py-[30px] text-[0.875rem] text-[#999] font-semibold pb-[30px] border-b-[1px] border-solid border-[#ccc]">
            ...
            <ul className="w-full mt-[30px]">
              {cart &&
                cart?.map((c) => {
                  return (
                    <li className="w-full p-4 mb-2 box-border bg-[#f6f6f6] flex justify-between items-center text-[0.875rem] text-[#333]">
                      <div>
                        <p>{c.title}</p>
                      ...
                      <p className="text-[0.9375rem]">
                        {attach_won(item.salePrice * c.count)}
                      </p>

                      <button onClick={deleteCart} className="text-[1.4rem] text-[#787878]">
                        <GoX />
                      </button>
                    </li>
                  );
