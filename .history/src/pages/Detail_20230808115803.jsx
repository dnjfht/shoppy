            ...
            <div className="w-[72%] p-5 box-border">
              <div>
                <div className="w-full flex flex-wrap">
                  ...
                  <div className="w-1/2 p-3 box-border border-y-[1px] border-l-[1px] border-solid border-[#c1c1c1] rounded-l-lg flex items-center">
                  ...
                  <div className="w-1/2 mt-3 p-3 box-border border-[1px] border-solid border-[#c1c1c1] rounded-r-lg flex items-center">
