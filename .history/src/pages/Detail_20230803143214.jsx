...
export default function Detail() {
  ...
  return (
    <div className="w-full">
      <div className="w-[1400px] mx-auto pt-52 pb-20 flex flex-co justify-between">
        <div className="w-full pt-20 border-b-[1px] border-bottom border-[#ccc] flex justify-between">
          <div className="w-[47%]">
            <img
