                ...
                <div className="w-full flex flex-wrap">
                  ...
                  {item?.option?.size && (
                    <select
                      ...
                      className="text-[#ff4273] w-1/2 p-3 mt-3 border-[1px] bg-transparent border-solid border-[#ff4273] outline-none rounded-l-lg placeholder:text-[]"
                    >
                      <option disabled selected>
                        옵션 색상 선택
                      </option>
                  ...
                  {item?.option?.size && (
                    <select
                      ...
                      className="w-1/2 p-3 mt-3 border-[1px] bg-transparent border-solid border-[#ff4273] outline-none rounded-r-lg text-[#ff4273]"
                    >
                      <option disabled selected>
                        옵션 사이즈 선택
                      </option>
