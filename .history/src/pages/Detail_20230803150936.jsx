        ...
        <div className="w-full pt-10">
          <div>
            ...
            <ul className="w-full flex justify-between items-center text-[0.8125rem] text-[#999]">
              <li className="w-1/6 py-1 border-r-[1px] border-solid border-[#ccc] flex flex-col items-center">
              ...
              <li className="w-1/6 border-r-[1px] border-solid border-[#ccc] flex flex-col items-center">
                <div className="mb-4 text-[3rem] text-[#f57778]">
                  <GiCutDiamond />
                </div>
                <p className="mb-2 text-[0.9375rem] text-[#333] font-semibold">
              ...
              <li className="w-1/6 flex flex-col items-center">
                <div className="mb-4 text-[3rem] text-[#f57778]">
                  <MdFiberNew />
                </div>
                <p className="mb-2 text-[0.9375rem] text-[#333] font-semibold">
