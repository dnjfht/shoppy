        ...
        <div className="w-full py-14 border-t-[1px] border-solid border-[#333] flex justify-between items-start">
          ...
          {cart && cart.length > 0 && (
            <>
              ...
              <div className="w-[26%]">
                <div className="w-full h-72 border-[1px] border-solid border-[#e5e5e5]">
                  {totalPrice < 50000 && (
                ...
                <div className="w-full flex flex-col items-center">
                  <button className="w-full py-5 box-border bg-[#282828] border-[1px] border-solid border-black text-white">
                    전체상품주문
                  </button>

                  <button className="w-full py-5 border-[1px] border-solid border-black">
                    선택상품주문
                  </button>

                  <button className="w-full py-5 flex justify-center items-center text-[#282828] border-[1px] border-solid border-black">
