                  ...
                  return (
                    <li className="w-[24%] mr-[1.333%] relative">
                      <div className="w-full group">
                        ...
                        <div className="group-hover:h-14 group-hover:bg-[rgba(0,0,0,0.6)] group-hover:shadow-[0_10px_12px_-2px_rgba(0,0,0,0.1)] absolute bottom-[72px] w-full h-0 bg-[rgba(255,255,255,0.94)] rounded-b-lg flex justify-center items-center transition-all duration-700 overflow-hidden">
