                    ...
                    <div className="w-1/2 px-5 box-border">
                      ...
                      <div className="w-full py-5 text-[0.8125rem]">
                        ...
                        <div className="mt-14 flex items-center">
                          ...
                          {user === null && (
                            <>
                              <button className="w-[100px] h-[30px] bg-[#ff4273] text-white border-[1px] border-solid border-[#ff4273] text-[0.8125rem] rounded-lg hover:text-[#ff4273] flex justify-center items-center">
                                수정하기
                              </button>
                              <button className="w-[100px] h-[30px] ml-2 bg-[#ff4273] text-white border-[1px] border-solid border-[#ff4273] text-[0.8125rem] rounded-lg hover:text-[#ff4273] hover:bg-opa flex justify-center items-center">
                                삭제하기
                              </button>
                            </>
                          )}
