  ...
  return (
    <div className="w-full">
      <div className="w-[1400px] mx-auto pt-52 pb-20 flex flex-col justify-between">
        <div className="w-full pt-20 pb-32 border-b-[1px] border-bottom border-[#ccc] flex justify-between">
          <div className="w-[47%]">
            <img
          ...
          <div className="w-[47%]">
            ...
            <div className="flex justify-between items-center font-semibold">
              <button className="w-[32%] py-5 border-[1px] border-solid border-black">
                장바구니
              </button>
        ...
        <div className="w-full pt-10">
          <div>
            ...
            <ul className="flex justify-between items-center text-[0.8125rem] text-[#999]">
              <li className="px-6 box-border border-r-[1px] border-solid border-[#ccc] flex flex-col items-center">
                <RiCoupon3Fill />
                <p className="text-[1.125rem] text-[#333]">신규회원 할인혜택</p>
                <p>회원가입 시 신규가입 축하</p>
                <p>20,000원 쿠폰팩 즉시 지급</p>
              </li>
              ...
              <li className="px-6 box-border border-r-[1px] border-solid border-[#ccc] flex flex-col items-center">
                ...
                <p>리뷰 작성시 적립금</p>
                <p>유형에 따라 적립금</p>
                <p>500원 ~ 1500원 차등 지급</p>
              </li>

              <li className="px-6 box-border flex flex-col items-center">
                <MdFiberNew />
                <p>신상 5% 할인</p>
                <p>매일 매일 UP되는 신상</p>
                <p>5% 할인가에 득템</p>
