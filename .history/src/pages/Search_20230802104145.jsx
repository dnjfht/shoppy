...
export default function Search() {
  ...
  return (
    <div className="w-full">
      <div className="w-full h-[640px] mt-[130px] my-custom-bg-class bg-cover bg-center bg-fixed bg-no-repeat text-white flex flex-col justify-center items-center">
        <h1 className="text-[5rem]">Birthday Party</h1>
        <p className="text-[1.7rem] mt-[-10px] mb-24">
          매일이 생일인 것처럼 특별한 하루를 선사해드립니다.
        </p>
