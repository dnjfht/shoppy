      ...
      <div className="w-[1400px] mx-auto pt-52 pb-20 flex justify-between">
        ...
        <div className="w-[47%]">
          ...
          <div className="w-full py-[30px]">
            <div className="w-full mb-2 flex text-[0.875rem] text-[#999] font-semibold">
              <p className="w-1/6">판매가</p>
              <p className="line-through w-5/6 text-[#333]">
                {attach_won(item.price)}
              </p>
            </div>
            <div className="w-full mb-2 flex">
              <p className="w-1/6">할인판매가</p>
              <p className="w-5/6 text-[#333]">{attach_won(item.salePrice)}</p>
            </div>
            <div className="w-full flex">
              <p className="w-1/6">상품간략설명</p>
              <p className="w-5/6 text-[#333]">{item.description}</p>
            </div>
          </div>
