                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items border-[1px] border-solid border-[#282828]">
                        <button className="w-8 h-8 flex justify-center items-center border-r-[1px] border-solid border-[#282828]">
                          -
                        </button>
                        <p className="w-8 h-8">{c.count}</p>
                        <button className="w-8 h-8 flex justify-center items-cente border-l-[1px] border-solid border-[#282828]">
                          +
                        </button>
                      </div>
