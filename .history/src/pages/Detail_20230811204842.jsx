                  ...
                  <div className="w-full px-4 flex">
                    ...
                    <div className="w-1/2 px-5 box-border">
                      ...
                      <div className="w-full py-5 text-[0.8125rem]">
                        <div className="w-full p-3 box-border text-[#898989] border-[1px] border-dotted border-[#f5f5f5]">
                          <p>{`선택한 옵션 : ${review.reviewColor} / ${review.reviewSize}`}</p>
                          <p>{`키 : ${review.reviewHeight}cm | 몸무게 : ${review.reviewWeight}kg | 평소 사이즈 : ${review.reviewBodySize}size | 발사이즈 : ${review.reviewBodyFoot}mm`}</p>
                          <p>{`색상 : ${review.reviewColorSatisfaction} | 사이즈 : ${review.reviewSizeSatisfaction}`}</p>
                        </div>
