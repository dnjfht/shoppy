        ...
        <div className="w-1/2 mt-20">
          <div className="w-full flex items-center mb-10">
            ...
            <input
              ...
              className="w-full px-4 py-6 placeholder:text-[#a5a5a5] bg-[rgba(0,0,0,0.6)] border-[2px] border-solid border-white"
            />
          </div>
          ...
          <div className="flex">
            ...
            <input
              ...
              className="w-1/2 px-4 py-6 placeholder:text-[#a5a5a5] bg-[rgba(0,0,0,0.6)] border-[2px] border-solid border-white"
            />
            <p>~</p>
            <input
              id="searchPrice"
