                  ...
                  return (
                    <li className="w-[24%] mr-[1.333%] relative">
                      <div className="w-full bg-black group">
                        ...
                        <div className="group-hover:h-16 group-hover:shadow-[0_-14px_12px_-2px_rgba(0,0,0,0.1)] absolute bottom-28 w-full h-0 bg-[rgba(255,221,141,0.94)] rounded-b-lg flex justify-center items-center text-xl transition-all duration-700 overflow-hidden">
                          <p>자세히 보기</p>
                        </div>
                      </div>
