        ...
        <div className="w-1/2 mt-20">
          <div className="w-full flex items-center mb-10">
            ...
            <input
              ...
              className="w-[80%] px-4 py-6 text-[1.1rem] placeholder:text-[#a5a5a5] bg-[rgba(0,0,0,0.6)] border-[2px] border-solid border-white"
            />
          </div>
          ...
          <div className="flex items-center">
            ...
            <input
              ...
              className="w-[38%] px-4 py-6 mr-[1%] text-[1.1rem] placeholder:text-[#a5a5a5] bg-[rgba(0,0,0,0.6)] border-[2px] border-solid border-white"
            />
            ...
            <input
              ...
              className="w-[38%] px-4 py-6 ml-[1%] text-[1.1rem] placeholder:text-[#a5a5a5] bg-[rgba(0,0,0,0.6)] border-[2px] border-solid border-white"
            />
          </div>
