        ...
        <MyBodySizeModal onClose={closeMyBodySizeModal}>
          <div className="w-full px-4 box-border">
            ...
            <div className="py-3 px-2 box-border">
              <div className="w-full py-3 px-5 box-border border-[1px] border-solid border-[#c1c1c1] rounded-lg flex items-center">
                <label
                  className="w-[30%] border-r-[1px] border-solid border-[#282828]"
                  htmlFor="myHeight"
                >
                  키
                </label>
                <input
                  className="w-[70%] ml-3 outline-none text-center"
                  id="myHeight"
                  type="text"
                  placeholder="0"
                />
              ...
              <div>
                <label htmlFor="myWeight">몸무게</label>
                <input id="myWeight" type="text" placeholder="0" />
              </div>

              <div>
                <label htmlFor="mySize">사이즈</label>
                <input id="mySize" type="text" placeholder="0" />
              </div>

              <div>
                <label htmlFor="myFoott">발사이즈</label>
                <input id="myFoot" type="text" placeholder="0" />
              </div>
            </div>
          </div>
        </MyBodySizeModal>
