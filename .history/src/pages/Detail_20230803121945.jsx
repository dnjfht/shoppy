                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items border-[1px] border-solid border-[#282828]">
                        <button className="px-1 flex justify-center items-center border-r-[1px] border-solid border-[#282828]">
                          -
                        </button>
                        <p className="px-1">{c.count}</p>
                        <button className="px-1 flex justify-center items-cente border-l-[1px] border-solid border-[#282828]">
                          +
                        </button>
                      </div>
