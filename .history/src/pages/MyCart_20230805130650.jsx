...
export default function MyCart({ allCarts, setAllCarts }) {
            ...
            <>
              <div className="w-[70%] ">
                          ...
                          <tr className="w-full border-b-[1px] border-solid border-[#e5e5e5]">
                            ...
                            <td className="w-[10%]">
                              <div className="w-full mx-auto flex items border-[1px] border-solid border-[#cacaca] font-normal">
                                <button className="w-8 h-8 text-[0.875rem] flex justify-center items-center border-r-[1px] border-solid border-[#cacaca]">
                                  -
                                </button>
                                <p className="w-8 h-8 flex justify-center items-center text-[0.875rem]">
                                  {cart.count}
                                </p>
                                <button className="w-8 h-8 text-[0.875rem] flex justify-center items-center border-l-[1px] border-solid border-[#cacaca]">
                                  +
                                </button>
                              </div>
                            </td>
                            ...
                            <td className="w-[10%] white text-center text-[0.875rem] text-[#333]">
                              <p>
                                {totalCount < 50000
                                  ? `${attach_won(2500)}\n\조건`
                                  : attach_won(0)}
                ...
                <div className="w-full mt-7 flex justify-between items-center">
                  <button className="h-[35px] px-3 border-[1px] border-solid border-[#e5e5e5] flex justify-center items-center">
