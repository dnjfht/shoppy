                ...
                cart?.map((c) => {
                  return (
                    ...
                    >
                      ...
                      {/* count 증가 감소 버튼 */}
                      <div className="flex items border-[1px] border-solid border-[#282828]">
                        <button className="w-8 h-8 bg-[#989797] text-white flex justify-center items-center border-r-[1px] border-solid border-[#282828]">
                          -
                        </button>
                        <p className="w-8 h-8 flex justify-center items-center">
                          {c.count}
                        </p>
                        <button className="w-8 h-8 bg-[#282828] text-white flex justify-center items-center border-l-[1px] border-solid border-[#282828]">
                          +
                        </button>
                      </div>
