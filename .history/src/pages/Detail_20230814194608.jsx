        ...
        <MyBodySizeModal onClose={closeMyBodySizeModal}>
          <div className="w-full px-4 box-border">
            ...
            <div className="py-3 px-2 box-border">
              ...
              <div className="w-full p-3 box-border border-[1px] border-solid border-[#c1c1c1] rounded-r-lg flex items-center">
                <label className="w-[30%]" htmlFor="myHeight">
                  키
                </label>
                <input id="myHeight" type="text" placeholder="0" />
              </div>
