...
export default function MyCart({
  ...
  console.log(nonMemberAllCarts, allCarts);
  return (
                          ...
                          return (
                            <tr className="w-full border-b-[1px] border-solid border-[#e5e5e5]">
                              ...
                              <td
                                ...
                                className="w-[20%] text-left text-[0.875rem] cursor-pointer"
                              >
                                <p className=" text-[#333] font-semibold">
                                  {item.title}
                                </p>
                                <p className="text-[#999]">{`[옵션: ${item.color}/${item.size}]`}</p>
                              </td>
                              <td className="w-[10%] text-center text-[0.875rem] text-[#333] font-semibold">
                                {attach_won(item.price * item.count)}
                              </td>
                              ...
                              <td className="w-[10%]">
                                <div className="w-full mx-auto flex items border-[1px] border-solid border-[#cacaca] font-normal">
                                  ...
                                  <button
                                    onClick={() => handlePlusCount(item.id)}
