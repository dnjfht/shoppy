                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items border-[1px] border-solid border-[#cacaca]">
                        <button className="w-8 h-8  flex justify-center items-center border-r-[1px] border-solid border-[#ababab]">
                          -
                        </button>
                        <p className="w-8 h-8 flex justify-center items-center">
                          {c.count}
                        </p>
                        <button className="w-8 h-8  flex justify-center items-center border-l-[1px] border-solid border-[#ababab]">
                          +
                        </button>
                      </div>
