                      ...
                      cart?.map((c) => {
                        return (
                          <tr className="w-full border-b-[1px] border-solid border-[#e5e5e5]">
                            ...
                            <td className="w-[10%]">
                              <div className="w-full mx-auto  bg-orange-500 flex items border-[1px] border-solid border-[#cacaca] font-normal">
                                <button className="w-8 h-8 bg-[#cacaca] text-[1.2rem] flex justify-center items-center border-r-[1px] border-solid border-[#cacaca]">
                                  -
                                </button>
                                <p className="w-8 h-8 flex justify-center items-center">
                                  {c.count}
                                </p>
                                <button className="w-8 h-8 bg-[#cacaca] text-[1.2rem] flex justify-center items-center border-l-[1px] border-solid border-[#cacaca]">
                                  +
                                </button>
                              </div>
                            </td>
