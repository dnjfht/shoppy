  ...
  return (
    ...
    >
      <div className="w-full group">
        <ul className="p-4 rounded-full bg-black flex flex-wrap justify-between items-center absolute top-2 left-2 [&>*:last-child]:ml-0">
          {item.type?.map((t) => {
            return <li className="text-white text-[0.9rem] ml-2">{t}</li>;
          })}
        </ul>
