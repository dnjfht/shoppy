...
export default function Navbar() {
  ...
  return (
    <div
      className={`${
        scrollHeight >= 140 ? "bg-[rgba(255,255,255,0)]" : "backdrop-opacity-0"
      } w-10/12 h-[130px] mx-auto flex items-center justify-between fixed left-0 right-0 z-[999999] bg-white transition-all duration-700`}
    >
