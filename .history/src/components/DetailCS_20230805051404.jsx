    ...
    <div className="w-full py-14 overflow-hidden relative">
      ...
      <ul className="list-outside list-disc [&>*]:mb-1 text-[0.875rem] text-[#333]">
        ...
        <li>
          ...
          <p>
            {"\u00A0"}
            {"\u00A0"}배송기간 : 오후 1시까지 입금 주문건에 한해 당일발송,
            접수일로부터 2~3일(일,공휴일 제외)
          </p>
        </li>
        <li>
          <p className="mb-1">
          ...
          <p>
            {"\u00A0"}
            {"\u00A0"}※ 택배(편의점 포함) 이용 시 선불로 발송 / 착불 발송 시
            추가 요금은 고객님 부담입니다.
          </p>
        </li>
        <li>
          <p>
            - 반송 택배는 상품 수거 후 2~4일 이내 물류센터 입고되며 업체 도착
            확인 후 1~2일 이내 처리 예정
          </p>
        </li>
        <li>
        ...
        <li>
          <p className="mb-1">
            -b 상품 출고이후 각지역 배송사 사정에따라 수령일 상이할 수 있으며 ,
