  ...
  return (
    ...
    >
      <div className="w-full group">
        <div className="w-12 h-12 rounded-full bg-black flex flex-wrap justify-center items-center absolute top-2 left-2">
          {item.type?.map((t) => {
            return <p className="text-white text-[0.9rem]">{t}</p>;
          })}
        </div>
