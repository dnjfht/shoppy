    ...
    <div className="flex flex-col justify-center">
      <div className="flex items-center justify-end">
        <button
          ...
          } p-[5px] bg-[#f4f3f3] border-[1px] border-solid border-[#c6c6c6] rounded-lg text-[1.1rem]`}
        >
          <BsChevronLeft />
        </button>
        <button
          ...
          className={`btn ${
            currentSlide + 8 >= filteredReviews.length
              ? "text-[#a4a4a4]"
              : "border-[#0f0f0f]"
          } ml-[6px] p-[5px] bg-[#f4f3f3] border-[1px] border-solid border-[#c6c6c6]  rounded-lg text-[1.1rem]`}
        >
          <BsChevronRight />
        </button>
      </div>
