        ...
        <div className="w-full">
          ...
          <ul className="w-full py-6">
            {filteredReviews.map((review) => (
              <li
                className="w-full pt-10 pb-14 flex justify-between border-b-[1px] border-solid border-[#dedede]"
                key={review.id}
              >
                {/* 리뷰 내용 출력 */}
                <div>
                  ...
                  <p>{`${review.reviewHeight}cm | ${review.reviewWeight}kg | ${review.reviewBodySize}size | ${review.reviewBodyFoot}mm`}</p>
                </div>
