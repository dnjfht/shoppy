                ...
                >
                  ...
                  <div className="w-9/12">
                    ...
                    <div className="mt-14 flex items-center">
                      ...
                      {user === null && (
                        <>
                          <button className="w-[120px] h-[40px] bg-[#000000] text-white border-[1px] border-solid border-[#000000] text-[0.8125rem] rounded-lg hover:text-[#000000] hover:bg-opacity-0 transition-all duration-700 flex justify-center items-center">
                            수정하기
                          </button>
                          <button className="w-[120px] h-[40px] ml-2 bg-[#000000] text-white border-[1px] border-solid border-[#000000] text-[0.8125rem] rounded-lg hover:text-[#000000] hover:bg-opacity-0 transition-all duration-700 flex justify-center items-center">
                            삭제하기
                          </button>
                        </>
                      )}
