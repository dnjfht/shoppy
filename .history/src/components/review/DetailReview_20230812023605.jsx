...
export default function DetailReview({
  ...
  const [reviewOfMyBodyType, setReviewOfMyBodyType] = useState({});
                ...
                >
                  ...
                  <div className="w-9/12">
                    ...
                    {reviewEdit.isActive && reviewEdit.id === review.id && (
                      <input
                        className="w-3/4 mt-5 p-3 box-border border-[1px] border-solid border-[#afafaf] rounded-lg outline-none"
                        type="text"
