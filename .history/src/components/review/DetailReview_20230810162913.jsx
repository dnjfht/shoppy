      ...
      <div>
        ...
        <div className="w-full">
          <div className="w-full py-3 flex justify-between items-center border-b-[1px] border-solid border-[#dedede]">
            ...
            <button onClick={openModal}>리뷰쓰기</button>
          </div>
          ...
          <ul className="w-full py-6">
            {filteredReviews &&
              filteredReviews?.map((review) => (
                <li
                  className="w-full pt-10 pb-12 flex justify-between border-b-[1px] border-solid border-[#dedede]"
                  key={review.id}
                >
                  {/* 리뷰 내용 출력 */}
                  ...
                  <div className="w-9/12">
                    ...
                    <div className="w-[510px] py-[15px] px-[23px] box-border border-[1px] border-dashed border-[#cdcdcd] rounded-xl flex items-center">
                      <p className="flex items-center">
                        선택한 옵션1 :{review.reviewColor}-
                        <span className="text-[#ff9691] text-[0.9375rem] font-semibold">
                      ...
                      <p className="flex items-center">
                        ...
                        <span>{review.reviewSizeSatisfaction}</span>
                      </p>
                    </div>
