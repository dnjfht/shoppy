    ...
    <div className="flex flex-col justify-center">
      <div className="flex items-center justify-end">
        <button
          ...
          className={`btn ${
            currentSlide === 0 ? "text-[#a4a4a4]" : ""
          } p-2 bg-[#f4f3f3] border-[1px] border-solid border-[#0f0f0f] rounded-lg text-[1.1rem]`}
        >
          <BsChevronLeft />
        </button>
        <button
          ...
          } ml-2 p-2 bg-[#f4f3f3] border-[1px] border-solid border-[#0f0f0f] rounded-lg text-[1.1rem]`}
        >
          <BsChevronRight />
        </button>
      </div>
