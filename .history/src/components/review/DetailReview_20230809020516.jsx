      ...
      <div>
        ...
        <ul className="w-full mt-6 flex justify-between">
          ...
          <li className="w-1/3 px-6 py-6 box-border text-[0.9375rem] text-center text-[#1e1d1d] font-semibold flex flex-col justify-between items-center">
            <p>리뷰필터</p>
            <div className="w-full flex-col items-center flex flex-col text-[0.75rem] font-normal">
              <div className="w-full flex justify-between items-center">
                <input className="w-[31%]" type="button" value="옵션색상" />
                <input className="w-[31%]" type="button" value="옵션사이즈" />
                <input className="w-[31%]" type="button" value="최신순" />
              </div>
              <input
                className="w-full bg-[#ff4273] text-white"
                type="button"
                value="검색"
              />
            </div>
