    ...
    <div className="w-full py-14 overflow-hidden relative">
      ...
      <div>
        ...
        <ul className="w-full flex justify-between">
          ...
          <li className="w-1/3 px-6 py-6 box-border text-[0.9375rem] text-center text-[#1e1d1d] font-semibold border-r-[1px] border-solid border-[#f3f3f3]">
            <p>평점 비율</p>
            <div className="w-full flex-col items-center">
              {/* 색상 */}
              <div className="w-full bg-pink-500 flex items-center justify-between">
                <div className="w-[86px] py-2 text-[#343434] font-normal border-[1px] border-solid border-[#c4c4c4] rounded-full">
                  <p>색상</p>
                </div>
