  ...
  return (
    <div className="w-full py-14 overflow-hidden relative">
      ...
      <div>
            ...
            <div className="w-full flex-col items-center">
              ...
              <div className="w-full mb-5 flex justify-between items-center font-normal">
                ...
                <div className="w-[76%] flex justify-between items-center">
                  ...
                  <p className="w-2/8 text-[1.125rem]">{`${colorSamePrecent}%`}</p>
                </div>
              </div>
              ...
              <div className="w-full flex justify-between items-center font-normal">
                ...
                <div className="w-[76%] flex justify-between items-center">
                  ...
                  <p className="w-2/8 text-[1.125rem]">{`${sizeSamePrecent}%`}</p>
                </div>
              </div>
            </div>
          </li>
        ...
        <ul className="w-full mt-5 mb-9 flex items-center [&>*:last-child]:mr-none">
          {filteredReviews.map((review) => (
            <li className="w-[12%] mr-[0.5%]" key={review.id}>
              <img
                className="w-full h-[168px] object-cover object-top rounded-lg"
