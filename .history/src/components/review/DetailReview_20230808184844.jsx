    ...
    <div className="w-full py-14 overflow-hidden relative">
      ...
      <div>
        ...
        <ul className="w-full mt-6 flex justify-between">
          ...
          <li className="w-1/3 px-6 py-6 box-border text-[0.9375rem] text-center text-[#1e1d1d] font-semibold border-r-[1px] border-solid border-[#f3f3f3] flex flex-col justify-between">
            <p>평점 비율</p>
