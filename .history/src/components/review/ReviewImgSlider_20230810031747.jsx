    ...
    return (
      ...
      >
        <div className="relative w-160 h-160 mr-3 group">
          ...
          />
          <div className="w-full h-full absolute bottom-0 left-0 p-4 box-border bg-black bg-opacity-70 text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
