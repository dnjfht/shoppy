  ...
  return (
    <div className="w-10/12 h-[130px] mx-auto flex items-center justify-between fixed left-0 right-0">
      ...
      <form className="w-3/12 relative">
        <input
          className="w-full h-[68px] px-6 box-border bg-transparent rounded-full border-[2px] border-solid border-white outline-none text-[1.1rem] placeholder:text-[#efefef]"
          type="text"
