    ...
    >
      <div className="w-10/12 h-full mx-auto flex items-center justify-between">
        ...
        <ul className="w-2/6 flex items-center justify-between text-[2rem]">
          <li className="relative after:absolute after:bottom-0 after:left-0 after:w-full after:opacity-0 after:h-[0.2rem] after:bg-[#282828] hover:after:opacity- transition-all duration-700">
            All
          </li>
          <li>Women</li>
          <li>Men</li>
