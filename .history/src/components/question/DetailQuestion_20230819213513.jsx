                ...
                return (
                  <div className="p-5 box-border">
                    ...
                    questionDetailModalEditIdBucket === data.id ? (
                      ...
                      >
                        <div className="w-4/5 mt-5 mb-80 flex justify-between items-center">
                          <input
                            value={changeContent}
                            onChange={(e) => {
                              e.preventDefault();
                            ...
                            className="w-full p-3 box-border border-[1px] border-solid border-[#ccc] rounded-lg outline-none"
                          />
                          <button className="w-1/5 py-2 bg-black bg-opacity-100 border-[1px] border-solid border-black mt-6 rounded-lg text-[0.875rem] text-white hover:bg-transparent hover:text-black transition-all duration-700">
                            수정 완료
                          </button>
                        </div>
                      </form>
