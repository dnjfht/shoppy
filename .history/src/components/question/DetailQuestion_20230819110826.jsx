            ...
            .map((data) => {
              return (
                <div className="p-5 box-border">
                  ...
                  <div>
                    <button className="w-44 last:py-3 bg-black bg-opacity-100 border-[1px] border-solid border-black mt-6 rounded-lg text-[0.875rem] text-white hover:border-white transition-all duration-700">
                      <p>수정</p>
                    </button>
                    <Button value="삭제" />
                  </div>
