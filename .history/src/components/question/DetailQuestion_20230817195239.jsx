            ...
            {!user && (
              <>
                <div className="w-full flex justify-between items-center">
                  ...
                  <input
                    id="phoneNumber"
                    className="w-full p-3 box-border border-[1px] border-solid border-[#e5e5e5] rounded-lg outline-none"
                    type="text"
                ...
                <div className="w-full mt-4 flex justify-between items-center">
                  ...
                  <input
                    id="password"
                    className="w-full mt-4 p-3 box-border border-[1px] border-solid border-[#e5e5e5] rounded-lg outline-none"
                    type="password"
