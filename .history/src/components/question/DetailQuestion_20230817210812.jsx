            ...
            {!user && (
              <div className="w-full mb-4 flex justify-between items-center">
                <div className="w-1/2 flex  items-center">
                  ...
                  <input
                    id="phoneNumber"
                    className="w-[72%] p-3 box-border border-[1px] border-solid border-[#e5e5e5] rounded-lg outline-none"
                    type="text"
                ...
                <div className="w-1/2 flex items-center">
                  ...
                  <input
                    id="password"
                    className="w-[72%] border-[1px] border-solid border-[#e5e5e5] rounded-lg outline-none"
                    type="password"
