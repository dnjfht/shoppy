...
export default function DetailQuestionList({
  ...
  return (
    <>
      <table className="w-full h-[620px] mt-4 text-center relative">
      ...
      <div className="w-full bg-orange-400 flex justify-center items-center absolute bottom-0">
        {totalPages > 1 && (
          <div>
            ...
            {Array.from({ length: totalPages }).map((_, index) => (
              <button
                ...
                className={`${currentPage === index + 1 ? "active" : ""} ml-2`}
              >
                {index + 1}
              </button>
            ))}
