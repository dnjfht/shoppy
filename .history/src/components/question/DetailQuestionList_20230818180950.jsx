    ...
    <>
      <table className="w-full mt-10 text-center">
        <thead className="w-full">
          <tr className="w-full">
            <th className="w-[1/8] bg-slate-400 py-6 border-b-[1px] border-solid border-[#dfdfdf]">
              번호
            </th>
            <th className="w-[5/8] bg-red-400 py-6 border-b-[1px] border-solid border-[#dfdfdf]">
              제목
            </th>
            <th className="w-[1/8] py-6 border-b-[1px] border-solid border-[#dfdfdf]">
              작성자
            </th>
            <th className="w-[1/8] py-6 border-b-[1px] border-solid border-[#dfdfdf]">
              작성일
