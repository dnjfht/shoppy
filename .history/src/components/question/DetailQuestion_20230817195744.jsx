          ...
          <div className="w-full p-4 box-border">
            {!user && (
              <>
                <div className="w-full flex justify-between items-center">
                  <div className="w-2/5">
                    <label className="w-1/4" htmlFor="phoneNumber">
                      전화번호
                    </label>
                    <input
                      id="phoneNumber"
                      className="w-3/4 p-3 box-border border-[1px] border-solid border-[#e5e5e5] rounded-lg outline-none"
                      type="text"
                  ...
                  <div className="w-2/5">
                    ...
                    <input
                      id="password"
                      className="w-3/12 p-3 box-border border-[1px] border-solid border-[#e5e5e5] rounded-lg outline-none"
                      type="password"
