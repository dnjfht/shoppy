  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-[22.5rem] h-[80px] absolute bottom-[50px] z-[999999] text-[1.2rem] rounded-[10px] bg-[#000000] mx-auto flex justify-center items-center text-[white] font-light hover:bg-[white] hover:border-[1px] hover:border-solid hover:border-[#282828] hover:text-[#282828] transition-all duration-[0.5s]"
